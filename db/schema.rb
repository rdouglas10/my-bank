...
ActiveRecord::Schema.define(version: 2020_05_23_021938) do
  ...
  create_table "deposits", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
